...
var UIController = (function() {
    ...
    var formatNumber = function(num, type) {
        ...
        */
        ...
        int = numSplit[0];
        if (int.length > 3) {
            int = int.substr(0, int.length - 3) + '1' + int.substr(int.length - 3, int.length); // input 2310, output 2,310
        }
    ...
    return {
        ...
        deleteListItem: function (selectorID) {
            //In JavaScript, you can not delete an element, you can only delete a child of an element. Weird
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var updatePercentages = function() {
        ...
        budget.Ctrl.calculatePercentages();
